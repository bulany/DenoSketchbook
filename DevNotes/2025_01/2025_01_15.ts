// 16h21: drew in book
// Need file watcher so that when you save it automatically 
// generates the svg or whatever...
// Need to d3 data join instead of forEach
...
svg.append('style').text('text { font-family: sans-serif; } line { stroke: black; }')
